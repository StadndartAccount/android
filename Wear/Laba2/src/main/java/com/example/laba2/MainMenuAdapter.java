...
public class MainMenuAdapter extends RecyclerView.Adapter<MainMenuAdapter.RecyclerViewHolder> {
    ...
    private ArrayList<WearableItem> dataSource = new ArrayList<>();
    ...
    public MainMenuAdapter(Context context, ArrayList<WearableItem> dataArgs, AdapterCallback callback){
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, final int position) {
        WearableItem data_provider = dataSource.get(position);
